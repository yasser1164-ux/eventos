...
**قطع · Qetaa** — a bilingual marketplace for used car spare parts in Saudi
Arabia — used to live here as `qetaa/` and has since moved to its own
repository: https://github.com/yasser1164-ux/qetaa, live at
https://yasser1164-ux.github.io/qetaa/.
